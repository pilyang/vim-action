...
| 2026-07-26 | 실행 실패 보고 단위 | 보고는 원인 키 입력 1건당 최대 1회 — 어댑터가 action 시퀀스 실패를 접는다(카운트 반복 출력이 임계를 압도하는 오탐 차단). M2 확정 항목: 백그라운드 큐 배선, 자동 트립의 재시작 영속 | [20260726_execution-failure-report-granularity.md](references/20260726_execution-failure-report-granularity.md) |
