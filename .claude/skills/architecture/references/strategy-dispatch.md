...
- **Last updated**: 2026-08-04 (M5 PR-C1 설계 반영 — Visual 앵커 상태 협력자·키보드 재앵커·읽기 자가 검증. 구현은 후속 세션)
