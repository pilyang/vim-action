...
- **Last updated**: 2026-08-04 (M5 PR-C1 구현 세션 1 — 앵커 협력자·세션 술어 읽기·자가 검증·`vh` 재앵커 구현. `vb`·`Vk`·`Vgg`·wise 전환 재조립·`V` 세션 스킵은 후속 세션)
