...
- [ ] (선택) v0.1.1 릴리스 시 설치된 v0.1.0에서 Sparkle 업데이트 다이얼로그→교체 설치까지의 진짜 end-to-end 확인
...
- 4단계 참고: cask는 v0.1.0의 DMG URL 패턴(`releases/download/vX.Y.Z/VimAction-X.Y.Z.dmg`) 기준, `auto_updates true` 선언, release 워크플로우에서 자동 bump 연결 예정.
