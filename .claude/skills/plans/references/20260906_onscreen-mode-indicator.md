...
- **생성일**: 2026-09-06
- **갱신일**: 2026-09-15 (PR 3 확장 — 순간 표시만 옵션·창 테두리 스타일·자기 pid 토큰 수정을 같은 브랜치에 커밋, 스크립트 도그푸딩 완료, Settings UI 경로·창 테두리 엣지는 사용자 직접 도그푸딩으로 인계)
