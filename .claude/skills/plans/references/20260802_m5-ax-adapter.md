...
- **생성일**: 2026-08-02
- **갱신일**: 2026-08-05 (**PR-C1 머지 완료** — main `f5a67c9`, worktree 정리됨. 다음은 PR-C2 — paste wise·스크롤 정확화)
...
- **PR-C2 착수 지점 (PR-C1 인계)** — 새 worktree에서 시작한다. 스코프는 위 "남은 것"의 PR-C2 항목: ① charwise/linewise `p` 경계 + paste wise 자체(레지스터·yank 경로의 wise 기억 — `PasteWiseResolver` 확장이 자연 자리다) ② 스크롤 근사 줄 수 → `AXVisibleCharacterRange` 뷰포트 정확화 ③ 비-QWERTY 정식 해소(문자→키코드 역조회 주입).
