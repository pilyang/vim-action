...
- [ ] **① Visual 모드 (`v`/`V`)** — 대형, Stage 2 관문. 세부 플랜: [20260721_visual-mode.md](20260721_visual-mode.md)
- [ ] **② 소형 묶음: `o`/`O`, `p`/`P`, `u`** — 각각 액션 케이스 신설 + Insert 전이/카운트 결정. Visual 작업 사이 짧은 세션용.
- [ ] **③ Ctrl 콤보 묶음: `Ctrl-d/u/f/b` 스크롤, `Ctrl-r`, `Ctrl-[`** — 키 추가보다 취소 최우선 순서의 전제 재검토가 본체([20260717 결정](../../decisions/references/20260717_cancellation-first-ordering-premise.md)에 재검토 조건 명시). 결정 기록 필수.
